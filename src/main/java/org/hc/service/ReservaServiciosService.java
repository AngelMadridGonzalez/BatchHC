...
public class ReservaServiciosService {
    ...
    public static void ReservasServicios () throws IOException {
        ...
        String line;
        String cvsSplitBy = ",";
        //id;lnk_idreservas;lnk_idreservascelanim;tipo;fecha;dias;cantidad;lnk_idtipservicios;observaci;precio;fechaserv
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(file))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                reservaServicios.setId(Integer.parseInt(datos[0].replaceAll("\"+", "")));
                ...
                reservaServicios.setIdReserva(Integer.parseInt(datos[1]));
